...
//		}
//		
//		TargetPathAgentStatus status = new TargetPathAgentStatus(Action,_target, data, new int[0], new ArrayList<Integer>());
//		
...
//			
//			status = new TargetPathAgentStatus(Action,_target, data, new int[0], new ArrayList<Integer>() );
